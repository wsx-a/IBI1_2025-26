...
# maximum and minimum DALYs across all rows
...
# ---------------------------------------------------
# Afghanistan: third and fourth columns for first 10 rows (inclusive)
# third and fourth columns mean column index 2 and 3 in Python counting
# here we first select Afghanistan, then take first 10 rows, then columns 2 and 3
# comment: among the first 10 years for Afghanistan, the maximum DALYs is in 1990
# ---------------------------------------------------
...
print("\nYear with maximum DALYs across first 10 Afghanistan rows:")
...
# comment: the code below prints the country with maximum and minimum DALYs in 2019
# ---------------------------------------------------
